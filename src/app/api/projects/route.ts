...
export async function POST(request: Request) {
  return withSession(async (session) => {
    ...
    const deptCode = await assertValidDepartment(body.dept_code);
    ...
    const statusId = body.status_id ? await assertValidStatus(body.status_id) : "NOT_STARTED";
    ...
    const projectId = await nextProjectId(deptCode);
